...
import {
  ...
  Question,
  Difficulty,
} from "../Physics/data/CurrentElectricityQuestions";
import {
  FaArrowLeft,
  FaArrowRight,
  FaArrowUp,
...
const CurrentElectricityQuiz: React.FC = () => {
  ...
  const getQuestions = useCallback((): Question[] => {
    ...
    return currentElectricityQuestions[difficulty] || [];
  }, [difficulty]);
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 to-blue-100 dark:from-gray-900 dark:to-gray-800 py-6 px-4 sm:px-6 lg:py-8">
      <Helmet>
        <title>Current Electricity Quiz | Physics Practice</title>
        <meta
          name="description"
          content="Practice Current Electricity concepts with MCQs. Test your knowledge of circuits, resistance, and Ohm's Law with explanations and instant feedback."
        />
        <meta name="keywords" content="current electricity, circuits, resistance, ohm's law, physics, quiz, mcq, practice" />
        ...
        >
          <div className="text-center mb-6">
            ...
            <p className="text-gray-600 dark:text-gray-300">
              Test your understanding of electric current, circuits, and resistance with interactive MCQs.
            </p>
          </div>
...
export default CurrentElectricityQuiz;