...
import {
  electromagneticInductionQuestions,
  Question,
  Difficulty,
} from "../Physics/data/ElectromagneticInductionQuestions";
import {
  FaArrowLeft,
  FaArrowRight,
  FaArrowUp,
...
const ElectromagneticInductionQuiz: React.FC = () => {
  ...
  const getQuestions = useCallback((): Question[] => {
    ...
    return electromagneticInductionQuestions[difficulty] || [];
  }, [difficulty]);
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 to-blue-100 dark:from-gray-900 dark:to-gray-800 py-6 px-4 sm:px-6 lg:py-8">
      <Helmet>
        <title>Electromagnetic Induction Quiz | Physics Practice</title>
        <meta
          name="description"
          content="Practice Electromagnetic-Induction with MCQs. Test your knowledge of Faraday's Law of
electromagnetic, induction,Lenz's Law with explanations and instant feedback."
        />
        <meta
          name="keywords"
          content="Electromagnetic,Induction,Lenz's Law , Faraday's Law of electromagnetic Induction , physics, quiz, MCQ, practice"
        />
        <script type="application/ld+json">
          {JSON.stringify({
            "@context": "https://schema.org",
            "@type": "Quiz",
            name: "Electromagnetic-Induction Quiz",
        ...
        >
          <div className="text-center mb-6">
            <div className="w-16 h-16 bg-indigo-100 dark:bg-indigo-900 rounded-full flex items-center justify-center mx-auto mb-4">
              <FaCircleNotch className="text-2xl text-indigo-500" />
            </div>
            <h1 className="text-3xl font-bold text-gray-800 dark:text-white mb-2">
              Electromagnetic-Induction Quiz
            </h1>
            <p className="text-gray-600 dark:text-gray-300">
              Test your understanding of Electromagnetic-Induction,Faraday's Law of electromagnetic ,Indcution,Lenz's Law and Transformer with
                interactive MCQs.
            </p>
          </div>
...
export default ElectromagneticInductionQuiz;
