...
import {
  ...
  Question,
  Difficulty,
} from "../Physics/data/NuclearPhysicsQuestions";
import {
  FaArrowLeft,
  FaArrowRight,
  FaArrowUp,
...
const NuclearPhysicsQuiz: React.FC = () => {
  ...
  const getQuestions = useCallback((): Question[] => {
    ...
    return nuclearPhysicsQuestions[difficulty] || [];
  }, [difficulty]);
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 to-blue-100 dark:from-gray-900 dark:to-gray-800 py-6 px-4 sm:px-6 lg:py-8">
      <Helmet>
        <title>Nuclear Physics Quiz | Physics Practice</title>
        <meta
          name="description"
          content="Practice Nuclear Physics concepts with MCQs. Test your knowledge of Composition of atomic nuclei,Spontaneous and
random nuclear decay,Half-life and rate of decay,Biological and Medical uses of radiation with explanations and instant feedback."
        />
        <meta
          name="keywords"
          content="Nuclear Physics, Composition of atomic nuclei,Spontaneous and
random nuclear decay,Half-life and rate of decay,Biological and Medical uses of radiation, physics, quiz, mcq, practice"
        />
        <script type="application/ld+json">
          {JSON.stringify({
            "@context": "https://schema.org",
            "@type": "Quiz",
            name: "Nuclear Physics Quiz",
        ...
        >
          <div className="text-center mb-6">
            <div className="w-16 h-16 bg-indigo-100 dark:bg-indigo-900 rounded-full flex items-center justify-center mx-auto mb-4">
              <FaAtom className="text-2xl text-indigo-500" />
            </div>
            <h1 className="text-3xl font-bold text-gray-800 dark:text-white mb-2">
              Nuclear Physics Quiz
            </h1>
            <p className="text-gray-600 dark:text-gray-300">
              Test your understanding of Nuclear Physics Composition of atomic nuclei,Spontaneous and random nuclear decay,Half-life and rate of decay,Biological and Medical uses of radiation with interactive MCQs.
            </p>
          </div>
...
export default NuclearPhysicsQuiz;
