...
import {
  ...
  Question,
  Difficulty,
} from "../Physics/data/ElectromagnetismQuestions";
import {
  FaArrowLeft,
  FaArrowRight,
  FaArrowUp,
...
const ElectromagnetismQuiz: React.FC = () => {
  ...
  const getQuestions = useCallback((): Question[] => {
    ...
    return electromagnetismQuestions[difficulty] || [];
  }, [difficulty]);
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 to-blue-100 dark:from-gray-900 dark:to-gray-800 py-6 px-4 sm:px-6 lg:py-8">
      <Helmet>
        <title>Electromagnetism Quiz | Physics Practice</title>
        <meta
          name="description"
          content="Practice Electromagnetism with MCQs. Test your knowledge of Magnetic flux, Motion of charged
particle in magnetic field,Magnetic flux  with explanations and instant feedback."
        />
        <meta
          name="keywords"
          content="Electromagnetism, Magnetic flux density/Magnetic field, Motion of charged particle in magnetic field,Magnetic flux, physics, quiz, MCQ, practice"
        />
        ...
        >
          <div className="text-center mb-6">
            <div className="w-16 h-16 bg-indigo-100 dark:bg-indigo-900 rounded-full flex items-center justify-center mx-auto mb-4">
              <FaMagnet className="text-2xl text-indigo-500" />
            </div>
            <h1 className="text-3xl font-bold text-gray-800 dark:text-white mb-2">
              Electromagnetism Quiz
            </h1>
            <p className="text-gray-600 dark:text-gray-300">
              Test your understanding of Magnetic flux density/Magnetic field,Magnetic flux and Motion of charged particle in magnetic field with interactive MCQs.
            </p>
          </div>
...
export default ElectromagnetismQuiz;
