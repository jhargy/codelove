...
import {
  ...
  Question,
  Difficulty,
} from "../Physics/data/workEnergyQuestions";
import {
  FaArrowLeft,
  FaArrowRight,
  FaArrowUp,
...
const WorkEnergyAndPowerQuiz: React.FC = () => {
  ...
  const getQuestions = useCallback((): Question[] => {
    ...
    return workAndEnergyQuestions[difficulty] || [];
  }, [difficulty]);
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 to-blue-100 dark:from-gray-900 dark:to-gray-800 py-6 px-4 sm:px-6 lg:py-8">
      <Helmet>
        <title>WorkEnergyAndPower Quiz | Physics Practice</title>
        <meta
          name="description"
          content="Practice WorkEnergyAndPower with MCQs. Test your knowledge of work , energy , power ,Kinetic Energy,Potential energy,Absolute potential
energy,Work energy theorem in resistive medium,Implications of energy losses in practical devices and Efficiency with explanations and instant feedback."
        />
        <meta
          name="keywords"
          content="work , energy , power ,Kinetic Energy,Potential energy,Absolute potential
energy,Work energy theorem in resistive medium,Implications of energy losses in practical devices and Efficiency,
MDCAT physics, quiz, MCQ, practice"
        />
        <script type="application/ld+json">
          {JSON.stringify({
            "@context": "https://schema.org",
            "@type": "Quiz",
            name: "WorkEnergyAndPower Quiz",
            about: "WorkEnergyAndPower",
        ...
        >
          <div className="text-center mb-6">
            ...
            <h1 className="text-3xl font-bold text-gray-800 dark:text-white mb-2">
              WorkEnergyAndPower Quiz
            </h1>
            <p className="text-gray-600 dark:text-gray-300">
              Test your understanding of Work,Energy and Power with interactive MCQs.
            </p>
          </div>
...
export default WorkEnergyAndPowerQuiz;
