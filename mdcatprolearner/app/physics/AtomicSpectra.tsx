...
import {
  atomicSpectraQuestions,
  Question,
  Difficulty,
} from "../Physics/data/AtomicSpectraQuestions";
import {
  FaArrowLeft,
  FaArrowRight,
  FaArrowUp,
...
const AtomicSpectraQuiz: React.FC = () => {
  ...
  const getQuestions = useCallback((): Question[] => {
    ...
    return atomicSpectraQuestions[difficulty] || [];
  }, [difficulty]);
  ...
  const handleNextLevel = () => {
    // Only allow easy level - disable next level functionality
    setDifficulty("easy");
    resetForNewRound();
    setQuizStarted(true);
  };
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 to-blue-100 dark:from-gray-900 dark:to-gray-800 py-6 px-4 sm:px-6 lg:py-8">
      <Helmet>
        <title>Atomic Spectra Quiz | Physics Practice</title>
        <meta
          name="description"
          content="Practice Atomic Spectra concepts with MCQs. Test your knowledge of Atomic Spetra with explanations and instant feedback."
        />
        <meta
          name="keywords"
          content="Atomic Spectra, line spectrum, physics, quiz, mcq, practice"
        />
        <script type="application/ld+json">
          {JSON.stringify({
            "@context": "https://schema.org",
            "@type": "Quiz",
            name: "Atomic Spectra Quiz",
        ...
        >
          <div className="text-center mb-6">
            <div className="w-16 h-16 bg-indigo-100 dark:bg-indigo-900 rounded-full flex items-center justify-center mx-auto mb-4">
              <FaRainbow className="text-2xl text-indigo-500" />
            </div>
            <h1 className="text-3xl font-bold text-gray-800 dark:text-white mb-2">
              Atomic Spectra Quiz
            </h1>
            <p className="text-gray-600 dark:text-gray-300">
              Test your understanding of Atomic Spectra with interactive MCQs.
            </p>
          </div>
          ...
          <div className="mb-6">
            ...
            <div className="flex flex-col space-y-3">
              {[
                ...
                { id: "medium" as Difficulty, label: "Medium (Locked)", color: "blue", locked: true },
                { id: "hard" as Difficulty, label: "Hard (Locked)", color: "red", locked: true },
              ].map((level) => (
                <button
                  key={level.id}
                  onClick={() => !level.locked && setDifficulty(level.id)}
          ...
          <div className="p-6 text-center">
            ...
            <div className="space-y-3">
              ...
              <button
                ...
                className="w-full py-3 bg-gray-400 text-white rounded-lg cursor-not-allowed flex items-center justify-center space-x-2 focus:ring-2 focus:ring-gray-500 focus:outline-none"
                aria-label="Next level unavailable"
                disabled
                title="Only Easy level is available"
              >
                <FaStepForward className="text-sm" /> <span>Next Level (Locked)</span>
              </button>
...
export default AtomicSpectraQuiz;