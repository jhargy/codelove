...
import {
  ...
  Question,
  Difficulty,
} from "../Physics/data/ElectronicsQuestions";
import {
  FaArrowLeft,
  FaArrowRight,
  FaArrowUp,
...
const ElectronicsQuiz: React.FC = () => {
  ...
  const getQuestions = useCallback((): Question[] => {
    ...
    return electronicsQuestions[difficulty] || [];
  }, [difficulty]);
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 to-blue-100 dark:from-gray-900 dark:to-gray-800 py-6 px-4 sm:px-6 lg:py-8">
      <Helmet>
        <title>Electronics Quiz | Physics Practice</title>
        <meta
          name="description"
          content="Practice Electronics with MCQs. Test your knowledge of Rectification and PN Junction with explanations and instant feedback."
        />
        <meta
          name="keywords"
          content="Electronics, Rectification , PN Junction, physics, quiz, MCQ, practice"
        />
        <script type="application/ld+json">
          {JSON.stringify({
            "@context": "https://schema.org",
            "@type": "Quiz",
            name: "Electronics Quiz",
            about: "Electronics",
        ...
        >
          <div className="text-center mb-6">
            ...
            <p className="text-gray-600 dark:text-gray-300">
              Test your understanding of Rectification and PN Junction with interactive MCQs.
            </p>
          </div>
...
export default ElectronicsQuiz;
