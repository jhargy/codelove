...
import {
  forceAndMotionQuestions,
  Question,
  Difficulty,
} from "../Physics/data/forceMotionQuestions";
import {
  FaArrowLeft,
  FaArrowRight,
  FaArrowUp,
...
const ForceMotionQuiz: React.FC = () => {
  ...
  const getQuestions = useCallback((): Question[] => {
    ...
    return forceAndMotionQuestions[difficulty] || [];
  }, [difficulty]);
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 to-blue-100 dark:from-gray-900 dark:to-gray-800 py-6 px-4 sm:px-6 lg:py-8">
      <Helmet>
        <title>Force and Motion Quiz | Physics Practice</title>
        <meta
          name="description"
          content="Practice Force and Motion with MCQs. Test your knowledge with explanations and instant feedback."
        />
        <meta name="keywords" content="force, motion, physics, newton, quiz, mcq, practice" />
      </Helmet>
        ...
        >
          <div className="text-center mb-6">
            ...
            <p className="text-gray-600 dark:text-gray-300">
              Test your knowledge of Newton's laws, forces, and motion with interactive MCQs.
            </p>
          </div>
...
export default ForceMotionQuiz;