...
import {
  ...
  Question,
  Difficulty,
} from "../Physics/data/ModernPhysicsQuestions";
import {
  FaArrowLeft,
  FaArrowRight,
  FaArrowUp,
...
const ModernPhysicsQuiz: React.FC = () => {
  ...
  const getQuestions = useCallback((): Question[] => {
    ...
    return modernPhysicsQuestions[difficulty] || [];
  }, [difficulty]);
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 to-blue-100 dark:from-gray-900 dark:to-gray-800 py-6 px-4 sm:px-6 lg:py-8">
      <Helmet>
        <title>ModernPhysics Quiz | Physics Practice</title>
        <meta
          name="description"
          content="Practice ModernPhysics with MCQs. Test your knowledge of Quantum Theory and
Radiation with explanations and instant feedback."
        />
        <meta
          name="keywords"
          content="ModernPhysics,Quantum Theory ,
Radiation, physics, quiz, MCQ, practice"
        />
        <script type="application/ld+json">
          {JSON.stringify({
            "@context": "https://schema.org",
            "@type": "Quiz",
            name: "ModernPhysics Quiz",
            about: "ModernPhysics",
        ...
        >
          <div className="text-center mb-6">
            ...
            <p className="text-gray-600 dark:text-gray-300">
              Test your understanding of Quantum Theory and Radiation with interactive MCQs.
            </p>
          </div>
          ...
          <div className="mb-6">
            ...
            <div className="flex flex-col space-y-3">
              {[
                { id: "easy" as Difficulty, label: "150 questions on the basic concepts", color: "green" },
...
export default ModernPhysicsQuiz;
