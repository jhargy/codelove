...
import {
  wavesAndOscillationsQuestions,
  Question,
  Difficulty,
} from "../Physics/data/WavesAndOscillationsQuestions";
import {
  FaArrowLeft,
  FaArrowRight,
  FaArrowUp,
...
const WavesAndOscillationsQuiz: React.FC = () => {
  ...
  const getQuestions = useCallback((): Question[] => {
    ...
    return wavesAndOscillationsQuestions[difficulty] || [];
  }, [difficulty]);
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 to-blue-100 dark:from-gray-900 dark:to-gray-800 py-6 px-4 sm:px-6 lg:py-8">
      <Helmet>
        <title>WavesAndOscillations Quiz | Physics Practice</title>
        <meta
          name="description"
          content="Practice WavesAndOscillations with MCQs. Test your knowledge of Motion of wave,Progressive waves,Characteristics of wave,Wave Speed,
          Progressive waves,Classification of progressive waves,Speed of sound,Newton’s Formula for speed of sound in air,Laplace’s Correction,Effect of various
           factors on speed of sound,Superposition of waves,Interference of sound waves,Stationary waves,Organ pipes,Superposition of waves,
           Simple Harmonic Motion, Terminologies of SHM, Circular motion and SHM,Energy with explanations and instant feedback."
        />
        <meta
          name="keywords"
          content="Waves physics, types of waves, transverse waves, longitudinal waves, mechanical waves, electromagnetic waves, sound waves, light waves, wave motion, wave properties, frequency, wavelength, amplitude, wave speed, wave equation, interference of waves, diffraction, reflection of waves, refraction, resonance, standing waves, progressive waves, superposition principle, wave energy, physics of waves, wave phenomena, oscillations and waves, physics waves MCQs, MDCAT waves, FSC physics waves
, physics, quiz, MCQ, practice"
        />
        <script type="application/ld+json">
          {JSON.stringify({
            "@context": "https://schema.org",
            "@type": "Quiz",
            name: "WavesAndOscillations Quiz",
            about: "WavesAndOscillations",
        ...
        >
          <div className="text-center mb-6">
            <div className="w-16 h-16 bg-indigo-100 dark:bg-indigo-900 rounded-full flex items-center justify-center mx-auto mb-4">
              <FaMicrochip className="text-2xl text-indigo-500" />
            </div>
            <h1 className="text-3xl font-bold text-gray-800 dark:text-white mb-2">
              WavesAndOscillations Quiz
            </h1>
            <p className="text-gray-600 dark:text-gray-300">
              Test your understanding of Waves And Oscillations with interactive MCQs.
            </p>
          </div>
...
export default WavesAndOscillationsQuiz;
