...
import {
  ...
  Question,
  Difficulty,
} from "../Physics/data/TheromdynamicsQuestions";
import {
  FaArrowLeft,
  FaArrowRight,
  FaArrowUp,
...
const ThermodynamicsQuiz: React.FC = () => {
  ...
  const getQuestions = useCallback((): Question[] => {
    ...
    return thermodynamicsQuestions[difficulty] || [];
  }, [difficulty]);
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 to-blue-100 dark:from-gray-900 dark:to-gray-800 py-6 px-4 sm:px-6 lg:py-8">
      <Helmet>
        <title>Thermodynamics Quiz | Physics Practice</title>
        <meta
          name="description"
          content="Practice Thermodynamics concepts with MCQs. Test your knowledge of heat, energy, entropy, and laws of thermodynamics with explanations and instant feedback."
        />
        <meta name="keywords" content="thermodynamics, heat, energy, entropy, physics, quiz, mcq, practice" />
        ...
        >
          <div className="text-center mb-6">
            ...
            <p className="text-gray-600 dark:text-gray-300">
              Test your understanding of heat, energy, entropy, and the laws of thermodynamics with interactive MCQs.
            </p>
          </div>
