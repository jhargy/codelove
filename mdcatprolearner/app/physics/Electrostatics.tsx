...
import {
  ...
  Question,
  Difficulty,
} from "../Physics/data/ElectrostaticsQuestions";
import {
  FaArrowLeft,
  FaArrowRight,
  FaArrowUp,
...
const ElectrostaticsQuiz: React.FC = () => {
  ...
  const getQuestions = useCallback((): Question[] => {
    ...
    return electrostaticsQuestions[difficulty] || [];
  }, [difficulty]);
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 to-blue-100 dark:from-gray-900 dark:to-gray-800 py-6 px-4 sm:px-6 lg:py-8">
      <Helmet>
        <title>Electrostatics Quiz | Physics Practice</title>
        <meta
          name="description"
          content="Practice Electrostatics with MCQs. Test your knowledge of Coulomb’s law, electric fields, potential, Gauss’s law, and capacitance with explanations and instant feedback."
        />
        <meta
          name="keywords"
          content="electrostatics, Coulomb's law, electric field, electric potential, Gauss's law, capacitance, physics, quiz, MCQ, practice"
        />
        ...
        >
          <div className="text-center mb-6">
            ...
            <p className="text-gray-600 dark:text-gray-300">
              Test your understanding of Coulomb’s law, electric field & potential, Gauss’s law, and capacitance with interactive MCQs.
            </p>
          </div>
...
export default ElectrostaticsQuiz;
