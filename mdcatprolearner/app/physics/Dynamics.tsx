...
import {
  ...
  Question,
  Difficulty,
} from "../Physics/data/DynamicsQuestions";
import {
  FaArrowLeft,
  FaArrowRight,
  FaArrowUp,
...
const DynamicsQuiz: React.FC = () => {
  ...
  const getQuestions = useCallback((): Question[] => {
    ...
    return dynamicsQuestions[difficulty] || [];
  }, [difficulty]);
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 to-blue-100 dark:from-gray-900 dark:to-gray-800 py-6 px-4 sm:px-6 lg:py-8">
      <Helmet>
        <title>Dynamics Quiz | Physics Practice</title>
        <meta
          name="description"
          content="Practice Dynamics concepts with MCQs. Test your knowledge of motion, forces, Newton's laws, and momentum with explanations and instant feedback."
        />
        <meta name="keywords" content="dynamics, motion, forces, Newton's laws, momentum, physics, quiz, mcq, practice" />
        ...
        >
          <div className="text-center mb-6">
            ...
            <p className="text-gray-600 dark:text-gray-300">
              Test your understanding of motion, forces, Newton's laws, and momentum with interactive MCQs.
            </p>
          </div>
