...
import {
  cellStructureQuestions,
  Question,
} from "../Biology/Data/cellStructureQuestions";
import {
  FaMicroscope,
  FaArrowLeft,
  FaArrowRight,
...
const CellStructureQuiz: React.FC = () => {
  ...
  const TOTAL_QUESTIONS = cellStructureQuestions.length;
  const SECTIONS = Math.ceil(TOTAL_QUESTIONS / QUESTIONS_PER_SECTION);

  const currentQuestions = cellStructureQuestions.slice(
  ...
  const handleAnswer = (id: string, index: number) => {
    try {
      ...
      const question = cellStructureQuestions.find((q) => q.id === id);
      if (!question) {
  ...
  const calculateScore = () => {
    try {
      let correct = 0;
      cellStructureQuestions.forEach((q) => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-50 to-emerald-100 dark:from-gray-900 dark:to-green-900/20 py-6 px-4 sm:px-6 lg:py-8">
      <Helmet>
        <title>MDCAT Cell Structure Quiz | Biology Practice</title>
        <meta
          name="description"
          content="Practice MDCAT Cell Structure questions with MCQs. Test your knowledge of cell organelles, membranes, cytoskeleton, and cellular organization with explanations and instant feedback."
        />
        <meta name="keywords" content="mdcat, cell structure, biology, organelles, cell membrane, cytoskeleton, quiz, mcq, practice, medical, exam" />
        <script type="application/ld+json">
          {`
            {
              "@context": "https://schema.org",
              "@type": "Quiz",
              "name": "MDCAT Cell Structure Quiz",
              "description": "Practice MDCAT Cell Structure questions with multiple choice questions and detailed explanations.",
              "educationalLevel": "advanced",
              "assesses": "Knowledge of cell structure for medical entrance exams",
        ...
        >
          <div className="text-center mb-6">
            <div className="w-16 h-16 bg-green-100 dark:bg-green-900 rounded-full flex items-center justify-center mx-auto mb-4">
              <FaMicroscope className="text-2xl text-green-600 dark:text-green-400" />
            </div>
            <h1 className="text-3xl font-bold text-gray-800 dark:text-white mb-2">
              MDCAT Cell Structure Quiz
            </h1>
            <p className="text-gray-600 dark:text-gray-300 mb-4">
              Comprehensive quiz with 150 questions covering all aspects of cell structure - from organelles to cellular organization.
            </p>
            <div className="bg-green-100 dark:bg-green-900/30 p-3 rounded-lg mb-4">
              <h3 className="font-semibold text-green-800 dark:text-green-200">Set 1: 150 Questions</h3>
              <p className="text-sm text-green-700 dark:text-green-300 mt-1">
                Basic to advanced level questions covering cell organelles, membranes, cytoskeleton, and cellular organization.
              </p>
            </div>
          </div>
          ...
          <div className="mb-6">
            ...
            <div className="bg-gray-100 dark:bg-gray-700 p-4 rounded-lg">
              ...
              <ul className="text-xs text-gray-600 dark:text-gray-300 list-disc pl-5 space-y-1">
                <li className="text-sm text-green-400 dark:text-green-300 mt-1"> Compare the structure of typical animal and plant cell</li>
                <li  >Organelles and their functions</li>
                <li>Cytoskeleton components</li>
                <li>Cell junctions and communication</li>
