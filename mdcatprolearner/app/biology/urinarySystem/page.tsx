...
import { urinarySystemQuestions } from "../data/urinarySystemQuestions";
import {
  FaTint,
  FaArrowLeft,
  FaArrowRight,
...
const UrinarySystemQuiz: React.FC = () => {
  ...
  const TOTAL_QUESTIONS = urinarySystemQuestions.length;
  const SECTIONS = Math.ceil(TOTAL_QUESTIONS / QUESTIONS_PER_SECTION);

  const currentQuestions = urinarySystemQuestions.slice(
  ...
  const handleAnswer = (id: string, index: number) => {
    try {
      ...
      const question = urinarySystemQuestions.find((q) => q.id === id);
      if (!question) {
  ...
  const calculateScore = () => {
    try {
      let correct = 0;
      urinarySystemQuestions.forEach((q) => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-50 to-indigo-100 dark:from-gray-900 dark:to-purple-900/20 py-6 px-4 sm:px-6 lg:py-8">
      <Helmet>
        <title>MDCAT Urinary System Quiz | Biology Practice Questions</title>
        <meta
          name="description"
          content="Comprehensive MDCAT quiz on the urinary system - kidneys, nephrons, urine formation, and renal physiology. Test your knowledge with detailed explanations and improve your exam preparation."
        />
        <meta 
          name="keywords" 
          content="MDCAT, urinary system, kidneys, nephrons, urine formation, renal physiology, bladder, ureters, urethra, biology quiz, medical exam, MCQs, practice questions" 
        />
        <meta name="author" content="MDCAT Prep" />
        <meta property="og:title" content="MDCAT Urinary System Quiz - Biology Practice" />
        <meta property="og:description" content="Practice MDCAT questions on the urinary system with detailed explanations and improve your exam performance." />
        <meta property="og:type" content="website" />
        <link rel="canonical" href="https://yourdomain.com/quizzes/urinary-system" />
      </Helmet>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-4 flex flex-col items-center justify-center border border-gray-200 dark:border-gray-700 backdrop-blur-sm bg-opacity-95">
              ...
              <div className="w-full mb-1">
                ...
                <div className="mt-1 text-xs text-gray-500 dark:text-gray-400">
                  Urinary System & Renal Physiology
                </div>
              </div>
            </div>
          </motion.div>
        ...
        >
          <div className="text-center mb-6">
            <div className="w-16 h-16 bg-purple-100 dark:bg-purple-900 rounded-full flex items-center justify-center mx-auto mb-4">
              <FaTint className="text-2xl text-purple-600 dark:text-purple-400" />
            </div>
            <h1 className="text-3xl font-bold text-gray-800 dark:text-white mb-2">
              MDCAT Urinary System Quiz
            </h1>
            <p className="text-gray-600 dark:text-gray-300 mb-4">
              Comprehensive quiz with 150 questions covering all aspects of the urinary system and renal physiology, essential for MDCAT biology preparation.
            </p>
            <div className="bg-purple-100 dark:bg-purple-900/30 p-3 rounded-lg mb-4">
              ...
              <p className="text-sm text-purple-700 dark:text-purple-300 mt-1">
                Detailed questions on kidney structure, nephron function, urine formation, and urinary disorders.
              </p>
            </div>
          </div>
          ...
          <div className="mb-6">
            ...
            <div className="bg-gray-100 dark:bg-gray-700 p-4 rounded-lg">
              ...
              <ul className="text-xs text-gray-600 dark:text-gray-300 list-disc pl-5 space-y-1">
                <li>Kidney anatomy and histology</li>
                <li>Nephron structure and function</li>
                <li>Urine formation processes</li>
                <li className="text-xs text-purple-700 dark:text-purple-300">Structure of kidney and relate it with its function.</li>
                <li className="text-xs text-purple-700 dark:text-purple-300">Different organs of urinary system</li>
                <li>Common urinary disorders</li>
                <li>Renal physiology and hormones</li>
          ...
          <button
            ...
            aria-label="Start Urinary System quiz"
          >
            Start Quiz
          </button>
        </motion.div>
                  ...
                  <div className="space-y-3">
                    {q.options.map((option, index) => {
                      ...
                      if (isLocked) {
                        if (isCorrectOption) {
                          buttonClass +=
                            " bg-purple-50 dark:bg-purple-900/30 border border-purple-200 dark:border-purple-800 text-purple-800 dark:text-purple-200";
        ...
        >
          <div className="p-6 text-center">
            ...
            {score !== null && (
              <div className="mb-6">
                {score >= 80 ? (
                  <div className="text-purple-600 dark:text-purple-400 font-semibold flex items-center justify-center space-x-2">
...
export default UrinarySystemQuiz;