...
import { excretionQuestions } from "../data/excretionQuestions";
import {
  FaFilter,
  FaArrowLeft,
  FaArrowRight,
...
const ExcretionQuiz: React.FC = () => {
  ...
  const TOTAL_QUESTIONS = excretionQuestions.length;
  const SECTIONS = Math.ceil(TOTAL_QUESTIONS / QUESTIONS_PER_SECTION);

  const currentQuestions = excretionQuestions.slice(
  ...
  const handleAnswer = (id: string, index: number) => {
    try {
      ...
      const question = excretionQuestions.find((q) => q.id === id);
      if (!question) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-teal-50 to-cyan-100 dark:from-gray-900 dark:to-teal-900/20 py-6 px-4 sm:px-6 lg:py-8">
      <Helmet>
        <title>MDCAT Excretion Quiz | Biology Waste Elimination Practice Questions</title>
        <meta
          name="description"
          content="Comprehensive MDCAT quiz on excretion - kidney function, nephron physiology, waste elimination, and urinary system. Test your knowledge with detailed explanations and improve your exam preparation."
        />
        <meta 
          name="keywords" 
          content="MDCAT, excretion, kidney function, nephron, waste elimination, urinary system, filtration, reabsorption, secretion, biology quiz, medical exam, physiology, MCQs, practice questions" 
        />
        <meta name="author" content="MDCAT Prep" />
        <meta property="og:title" content="MDCAT Excretion Quiz - Biology Waste Elimination Practice" />
        <meta property="og:description" content="Practice MDCAT questions on excretion with detailed explanations and improve your exam performance." />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://yourdomain.com/quizzes/excretion" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="MDCAT Excretion Quiz - Biology Practice" />
        <meta name="twitter:description" content="Test your knowledge of excretion with our comprehensive MDCAT quiz." />
        <link rel="canonical" href="https://yourdomain.com/quizzes/excretion" />
        <script type="application/ld+json">
          {`
            {
              "@context": "https://schema.org",
              "@type": "Quiz",
              "name": "MDCAT Excretion Quiz",
              "description": "Practice MDCAT questions on excretion with multiple choice questions and detailed explanations.",
              "educationalLevel": "advanced",
              "assesses": "Knowledge of excretion and waste elimination for medical entrance exams",
          ...
          >
            ...
            >
              ...
              <button
                ...
                className="px-6 py-2 bg-teal-600 text-white rounded-lg shadow hover:bg-teal-700 transition focus:ring-2 focus:ring-teal-500 focus:outline-none"
              >
                Okay
              </button>
            </motion.div>
      ...
      {!quizStarted ? (
        ...
        >
          <div className="text-center mb-6">
            <div className="w-16 h-16 bg-teal-100 dark:bg-teal-900 rounded-full flex items-center justify-center mx-auto mb-4">
              <FaFilter className="text-2xl text-teal-600 dark:text-teal-400" />
            </div>
            <h1 className="text-3xl font-bold text-gray-800 dark:text-white mb-2">
              MDCAT Excretion Quiz
            </h1>
            <p className="text-gray-600 dark:text-gray-300 mb-4">
              Comprehensive quiz with 100 questions covering all aspects of excretion and waste elimination, essential for MDCAT biology preparation.
            </p>
            <div className="bg-teal-100 dark:bg-teal-900/30 p-3 rounded-lg mb-4">
              <h3 className="font-semibold text-teal-800 dark:text-teal-200">Set 1: 100 Questions</h3>
              <p className="text-sm text-teal-700 dark:text-teal-300 mt-1">
                Detailed questions on kidney function, nephron physiology, and waste elimination processes.
              </p>
            </div>
          </div>
          ...
          <div className="mb-6">
            ...
            <div className="grid grid-cols-2 gap-3 mb-4">
              <div className="bg-teal-50 dark:bg-teal-900/20 p-3 rounded-lg text-center">
                ...
                <div className="text-xs text-teal-700 dark:text-teal-300">Questions</div>
              </div>
              <div className="bg-teal-50 dark:bg-teal-900/20 p-3 rounded-lg text-center">
                <div className="text-2xl font-bold text-teal-60 dark:text-teal-400">10</div>
                <div className="text-xs text-teal-700 dark:text-teal-300">Sections</div>
              </div>
            </div>
            ...
            <div className="bg-gray-100 dark:bg-gray-700 p-4 rounded-lg">
              ...
              <ul className="text-xs text-gray-600 dark:text-gray-300 list-disc pl-5 space-y-1">
                <li>Kidney structure and function</li>
                <li>Nephron physiology</li>
                <li>Filtration, reabsorption, and secretion</li>
                <li>Urine formation and composition</li>
                <li>Regulation of water and electrolyte balance</li>
                <li>Role of hormones in excretion</li>
                <li>Disorders of the urinary system</li>
                <li>Comparative excretion in different organisms</li>
                <li>Liver and skin excretion functions</li>
                 <li className="text-xs text-teal-700 dark:text-teal-300">Nitrogenous waste elimination</li>
          ...
          <button
            ...
            className="w-full py-3 bg-teal-600 text-white rounded-xl hover:bg-teal-700 transition focus:ring-2 focus:ring-teal-500 focus:outline-none"
            aria-label="Start Excretion quiz"
          >
            Start Quiz
          </button>
        </motion.div>
        ...
        >
          <div className="p-5 border-b border-gray-200 dark:border-gray-700">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
              ...
              <span className="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-teal-100 text-teal-800 dark:bg-teal-900/30 dark:text-teal-200">
                SET 1
              </span>
            </div>
                ...
                >
                  ...
                  <div className="space-y-3">
                    {q.options.map((option, index) => {
                      ...
                      let buttonClass =
                        "w-full p-3 rounded-lg transition-all text-left focus:outline-none focus:ring-2 focus:ring-teal-500 ";

                      if (isLocked) {
                        if (isCorrectOption) {
                          buttonClass +=
                            " bg-teal-50 dark:bg-teal-900/30 border border-teal-200 dark:border-teal-800 text-teal-800 dark:text-teal-200";
                        ...
                        buttonClass += isUserAnswer
                          ? " bg-teal-50 dark:bg-teal-900/30 border border-teal-200 dark:border-teal-700 text-teal-800 dark:text-teal-200"
                  ...
                  {isLocked && (
                    <div className="mt-4">
                      <button
                        ...
                        className="flex items-center space-x-2 text-teal-600 dark:text-teal-400 hover:text-teal-700 dark:hover:text-teal-300 text-sm font-medium"
                      ...
                      <AnimatePresence>
                        {showExplanations[q.id] && (
                          <motion.div
                            ...
                            className="mt-3 p-3 bg-teal-50 dark:bg-gray-600 rounded-lg text-sm text-gray-700 dark:text-gray-200"
                            aria-live="polite"
                          >
                            {q.explanation}
                          </motion.div>
          ...
          <div className="p-5 border-t border-gray-200 dark:border-gray-700 flex flex-col sm:flex-row justify-between items-center space-y-4 sm:space-y-0">
            ...
            <button
              ...
              className="px-4 py-2 rounded-lg flex items-center space-x-2 bg-teal-600 hover:bg-teal-700 text-white focus:ring-2 focus:ring-teal-500 focus:outline-none"
        ...
        >
          <div className="p-6 text-center">
            <div className="w-20 h-20 bg-teal-100 dark:bg-teal-900 rounded-full flex items-center justify-center mx-auto mb-5">
            ...
            <p className="text-gray-600 dark:text-gray-300 mb-5">
              You scored <span className="font-bold text-teal-600 dark:text-teal-400">{score}%</span> out of{" "}
            ...
            {score !== null && (
              <div className="mb-6">
                {score >= 80 ? (
                  <div className="text-teal-600 dark:text-teal-400 font-semibold flex items-center justify-center space-x-2">
            ...
            <div className="space-y-3">
              <button
                ...
                className="w-full py-3 bg-teal-600 text-white rounded-lg hover:bg-teal-700 flex items-center justify-center space-x-2 focus:ring-2 focus:ring-teal-500 focus:outline-none"
      ...
      <AnimatePresence>
        {showTopBtn && (
          <motion.button
            ...
            className="fixed bottom-4 right-4 bg-teal-600 text-white p-3 rounded-full shadow-lg hover:bg-teal-700 focus:outline-none focus:ring-2 focus:ring-teal-500 focus:ring-offset-2"
