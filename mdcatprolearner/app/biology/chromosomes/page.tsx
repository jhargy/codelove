...
import {
  chromosomesQuestions,
  Question,
} from "../data/chromosomesQuestions";
import {
  FaDna,
  FaArrowLeft,
  FaArrowRight,
...
const ChromosomesQuiz: React.FC = () => {
  ...
  const TOTAL_QUESTIONS = chromosomesQuestions.length;
  const SECTIONS = Math.ceil(TOTAL_QUESTIONS / QUESTIONS_PER_SECTION);

  const currentQuestions = chromosomesQuestions.slice(
  ...
  const handleAnswer = (id: string, index: number) => {
    try {
      ...
      const question = chromosomesQuestions.find((q) => q.id === id);
      if (!question) {
  ...
  const calculateScore = () => {
    try {
      let correct = 0;
      chromosomesQuestions.forEach((q) => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-pink-50 to-rose-100 dark:from-gray-900 dark:to-pink-900/20 py-6 px-4 sm:px-6 lg:py-8">
      <Helmet>
        <title>MDCAT Chromosomes Quiz | Biology Practice</title>
        <meta
          name="description"
          content="Practice MDCAT Chromosomes questions with MCQs. Test your knowledge of chromosome structure, types, abnormalities, and genetic inheritance with explanations and instant feedback."
        />
        <meta name="keywords" content="mdcat, chromosomes, biology, genetics, karyotype, chromosomal abnormalities, quiz, mcq, practice, medical, exam" />
        <script type="application/ld+json">
          {`
            {
              "@context": "https://schema.org",
              "@type": "Quiz",
              "name": "MDCAT Chromosomes Quiz",
              "description": "Practice MDCAT Chromosomes questions with multiple choice questions and detailed explanations.",
              "educationalLevel": "advanced",
              "assesses": "Knowledge of chromosomes for medical entrance exams",
          ...
          >
            ...
            >
              ...
              <button
                ...
                className="px-6 py-2 bg-pink-600 text-white rounded-lg shadow hover:bg-pink-700 transition focus:ring-2 focus:ring-pink-500 focus:outline-none"
              >
                Okay
              </button>
            </motion.div>
      ...
      {!quizStarted ? (
        ...
        >
          <div className="text-center mb-6">
            <div className="w-16 h-16 bg-pink-100 dark:bg-pink-900 rounded-full flex items-center justify-center mx-auto mb-4">
              <FaDna className="text-2xl text-pink-600 dark:text-pink-400" />
            </div>
            <h1 className="text-3xl font-bold text-gray-800 dark:text-white mb-2">
              MDCAT Chromosomes Quiz
            </h1>
            <p className="text-gray-600 dark:text-gray-300 mb-4">
              Comprehensive quiz with 150 questions covering all aspects of chromosomes - from structure and function to abnormalities and genetic disorders.
            </p>
            <div className="bg-pink-100 dark:bg-pink-900/30 p-3 rounded-lg mb-4">
              <h3 className="font-semibold text-pink-800 dark:text-pink-200">Set 1: 150 Questions</h3>
              <p className="text-sm text-pink-700 dark:text-pink-300 mt-1">
                Basic to advanced level questions covering chromosome structure, types, abnormalities, and genetic inheritance.
              </p>
            </div>
          </div>
          ...
          <div className="mb-6">
            ...
            <div className="grid grid-cols-2 gap-3 mb-4">
              <div className="bg-pink-50 dark:bg-pink-900/20 p-3 rounded-lg text-center">
                ...
                <div className="text-xs text-pink-700 dark:text-pink-300">Questions</div>
              </div>
              <div className="bg-pink-50 dark:bg-pink-900/20 p-3 rounded-lg text-center">
                <div className="text-2xl font-bold text-pink-600 dark:text-pink-400">20</div>
                <div className="text-xs text-pink-700 dark:text-pink-300">Sections</div>
              </div>
            </div>
            ...
            <div className="bg-gray-100 dark:bg-gray-700 p-4 rounded-lg">
              ...
              <ul className="text-xs text-gray-600 dark:text-gray-300 list-disc pl-5 space-y-1">
                <li className="text-sm text-green-400 dark:text-green-300 mt-1">Structure, chemical composition and function of chromosomes.</li>
                <li>Types of chromosomes (autosomes, sex chromosomes)</li>
                <li>Chromosomal abnormalities and disorders</li>
                <li>Karyotyping and chromosomal analysis</li>
              </ul>
            </div>
          </div>
          ...
          <button
            ...
            className="w-full py-3 bg-pink-600 text-white rounded-xl hover:bg-pink-700 transition focus:ring-2 focus:ring-pink-500 focus:outline-none"
        ...
        >
          <div className="p-5 border-b border-gray-200 dark:border-gray-700">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
              ...
              <span className="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-pink-100 text-pink-800 dark:bg-pink-900/30 dark:text-pink-200">
                SET 1
              </span>
            </div>
                ...
                >
                  ...
                  <div className="space-y-3">
                    {q.options.map((option, index) => {
                      ...
                      let buttonClass =
                        "w-full p-3 rounded-lg transition-all text-left focus:outline-none focus:ring-2 focus:ring-pink-500 ";
                      ...
                      if (isLocked) {
                        ...
                        buttonClass += isUserAnswer
                          ? " bg-pink-50 dark:bg-pink-900/30 border border-pink-200 dark:border-pink-700 text-pink-800 dark:text-pink-200"
                  ...
                  {isLocked && (
                    <div className="mt-4">
                      <button
                        ...
                        className="flex items-center space-x-2 text-pink-600 dark:text-pink-400 hover:text-pink-700 dark:hover:text-pink-300 text-sm font-medium"
                      ...
                      <AnimatePresence>
                        {showExplanations[q.id] && (
                          <motion.div
                            ...
                            className="mt-3 p-3 bg-pink-50 dark:bg-gray-600 rounded-lg text-sm text-gray-700 dark:text-gray-200"
                            aria-live="polite"
                          >
                            {q.explanation}
                          </motion.div>
          ...
          <div className="p-5 border-t border-gray-200 dark:border-gray-700 flex flex-col sm:flex-row justify-between items-center space-y-4 sm:space-y-0">
            ...
            <button
              ...
              className="px-4 py-2 rounded-lg flex items-center space-x-2 bg-pink-600 hover:bg-pink-700 text-white focus:ring-2 focus:ring-pink-500 focus:outline-none"
        ...
        >
          <div className="p-6 text-center">
            <div className="w-20 h-20 bg-pink-100 dark:bg-pink-900 rounded-full flex items-center justify-center mx-auto mb-5">
            ...
            <p className="text-gray-600 dark:text-gray-300 mb-5">
              You scored <span className="font-bold text-pink-600 dark:text-pink-400">{score}%</span> out of{" "}
            ...
            <div className="space-y-3">
              <button
                ...
                className="w-full py-3 bg-pink-600 text-white rounded-lg hover:bg-pink-700 flex items-center justify-center space-x-2 focus:ring-2 focus:ring-pink-500 focus:outline-none"
      ...
      <AnimatePresence>
        {showTopBtn && (
          <motion.button
            ...
            className="fixed bottom-4 right-4 bg-pink-600 text-white p-3 rounded-full shadow-lg hover:bg-pink-700 focus:outline-none focus:ring-2 focus:ring-pink-500 focus:ring-offset-2"
...
export default ChromosomesQuiz;