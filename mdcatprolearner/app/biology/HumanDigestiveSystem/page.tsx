...
import {
  digestiveSystemQuestions,
  Question,
} from "../data/digestiveSystemQuestions";
import {
FaStethoscope,
  FaArrowLeft,
  FaArrowRight,
...
const HumanDigestiveSystemQuiz: React.FC = () => {
  ...
  const TOTAL_QUESTIONS = digestiveSystemQuestions.length;
  const SECTIONS = Math.ceil(TOTAL_QUESTIONS / QUESTIONS_PER_SECTION);

  const currentQuestions = digestiveSystemQuestions.slice(
  ...
  const handleAnswer = (id: string, index: number) => {
    try {
      ...
      const question = digestiveSystemQuestions.find((q) => q.id === id);
      if (!question) {
  ...
  const calculateScore = () => {
    try {
      let correct = 0;
      digestiveSystemQuestions.forEach((q) => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 to-red-100 dark:from-gray-900 dark:to-orange-900/20 py-6 px-4 sm:px-6 lg:py-8">
      <Helmet>
        <title>MDCAT Human Digestive System Quiz | Biology Practice</title>
        <meta
          name="description"
          content="Practice MDCAT questions on the human digestive system. Test your knowledge of digestive organs, enzymes, digestion processes, and absorption with detailed explanations."
        />
        <meta name="keywords" content="mdcat, human digestive system, digestion, gastrointestinal tract, enzymes, absorption, biology, quiz, mcq, practice, medical, exam" />
        <script type="application/ld+json">
          {`
            {
              "@context": "https://schema.org",
              "@type": "Quiz",
              "name": "MDCAT Human Digestive System Quiz",
              "description": "Practice MDCAT questions on the human digestive system with multiple choice questions and detailed explanations.",
              "educationalLevel": "advanced",
              "assesses": "Knowledge of human digestive system for medical entrance exams",
          ...
          >
            ...
            >
              ...
              <button
                ...
                className="px-6 py-2 bg-orange-600 text-white rounded-lg shadow hover:bg-orange-700 transition focus:ring-2 focus:ring-orange-500 focus:outline-none"
              >
                Okay
              </button>
            </motion.div>
        ...
        >
          <div className="text-center mb-6">
            <div className="w-16 h-16 bg-orange-100 dark:bg-orange-900 rounded-full flex items-center justify-center mx-auto mb-4">
              <FaStethoscope className="text-2xl text-orange-600 dark:text-orange-400" />
            </div>
            <h1 className="text-3xl font-bold text-gray-800 dark:text-white mb-2">
              MDCAT Human Digestive System Quiz
            </h1>
            <p className="text-gray-600 dark:text-gray-300 mb-4">
              Comprehensive quiz with 100 questions covering all aspects of the human digestive system, essential for MDCAT biology preparation.
            </p>
            <div className="bg-orange-100 dark:bg-orange-900/30 p-3 rounded-lg mb-4">
              <h3 className="font-semibold text-orange-800 dark:text-orange-200">Set 1: 100 Questions</h3>
              <p className="text-sm text-orange-700 dark:text-orange-300 mt-1">
                Detailed questions on digestive organs, enzymes, digestion processes, and nutrient absorption.
              </p>
            </div>
          </div>
          ...
          <div className="mb-6">
            ...
            <div className="grid grid-cols-2 gap-3 mb-4">
              <div className="bg-orange-50 dark:bg-orange-900/20 p-3 rounded-lg text-center">
                ...
                <div className="text-xs text-orange-700 dark:text-orange-300">Questions</div>
              </div>
              <div className="bg-orange-50 dark:bg-orange-900/20 p-3 rounded-lg text-center">
                <div className="text-2xl font-bold text-orange-600 dark:text-orange-400">10</div>
                <div className="text-xs text-orange-700 dark:text-orange-300">Sections</div>
              </div>
            </div>
            ...
            <div className="bg-gray-100 dark:bg-gray-700 p-4 rounded-lg">
              ...
              <ul className="text-xs text-gray-600 dark:text-gray-300 list-disc pl-5 space-y-1">
                <li>Structure and function of digestive organs</li>
                <li>Digestive enzymes and their roles</li>
                <li>Mechanical and chemical digestion processes</li>
                <li>Nutrient absorption mechanisms</li>
                <li>Liver, gallbladder, and pancreatic functions</li>
                <li>Digestive disorders and diseases</li>
                <li>Hormonal control of digestion</li>
                <li>Comparative anatomy of digestive systems</li>
              </ul>
            </div>
          </div>
          ...
          <button
            ...
            className="w-full py-3 bg-orange-600 text-white rounded-xl hover:bg-orange-700 transition focus:ring-2 focus:ring-orange-500 focus:outline-none"
        ...
        >
          <div className="p-5 border-b border-gray-200 dark:border-gray-700">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
              ...
              <span className="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-orange-100 text-orange-800 dark:bg-orange-900/30 dark:text-orange-200">
                SET 1
              </span>
            </div>
                ...
                >
                  ...
                  <div className="space-y-3">
                    {q.options.map((option, index) => {
                      ...
                      let buttonClass =
                        "w-full p-3 rounded-lg transition-all text-left focus:outline-none focus:ring-2 focus:ring-orange-500 ";
                      ...
                      if (isLocked) {
                        ...
                        buttonClass += isUserAnswer
                          ? " bg-orange-50 dark:bg-orange-900/30 border border-orange-200 dark:border-orange-700 text-orange-800 dark:text-orange-200"
                      ...
                      <AnimatePresence>
                        {showExplanations[q.id] && (
                          <motion.div
                            ...
                            className="mt-3 p-3 bg-orange-50 dark:bg-gray-600 rounded-lg text-sm text-gray-700 dark:text-gray-200"
                            aria-live="polite"
                          >
                            {q.explanation}
                          </motion.div>
          ...
          <div className="p-5 border-t border-gray-200 dark:border-gray-700 flex flex-col sm:flex-row justify-between items-center space-y-4 sm:space-y-0">
            ...
            <button
              ...
              className="px-4 py-2 rounded-lg flex items-center space-x-2 bg-orange-600 hover:bg-orange-700 text-white focus:ring-2 focus:ring-orange-500 focus:outline-none"
          ...
          <div className="p-6 text-center">
            ...
            <div className="space-y-3">
              <button
                ...
                className="w-full py-3 bg-orange-600 text-white rounded-lg hover:bg-orange-700 flex items-center justify-center space-x-2 focus:ring-2 focus:ring-orange-500 focus:outline-none"
      ...
      <AnimatePresence>
        {showTopBtn && (
          <motion.button
            ...
            className="fixed bottom-4 right-4 bg-orange-600 text-white p-3 rounded-full shadow-lg hover:bg-orange-700 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:ring-offset-2"
...
export default HumanDigestiveSystemQuiz;