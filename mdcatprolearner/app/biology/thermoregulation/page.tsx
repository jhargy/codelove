...
import { thermoregulationQuestions } from "../data/thermoregulationQuestions";
import {
  FaThermometerHalf,
  FaArrowLeft,
  FaArrowRight,
...
const ThermoregulationQuiz: React.FC = () => {
  ...
  const TOTAL_QUESTIONS = thermoregulationQuestions.length;
  console.log(TOTAL_QUESTIONS);
  const SECTIONS = Math.ceil(TOTAL_QUESTIONS / QUESTIONS_PER_SECTION);

  const currentQuestions = thermoregulationQuestions.slice(
  ...
  const handleAnswer = (id: string, index: number) => {
    try {
      ...
      const question = thermoregulationQuestions.find((q) => q.id === id);
      if (!question) {
  ...
  const calculateScore = () => {
    try {
      let correct = 0;
      thermoregulationQuestions.forEach((q) => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-red-50 to-orange-100 dark:from-gray-900 dark:to-red-900/20 py-6 px-4 sm:px-6 lg:py-8">
      <Helmet>
        <title>MDCAT Thermoregulation Quiz | Biology Temperature Regulation Practice Questions</title>
        <meta
          name="description"
          content="Comprehensive MDCAT quiz on thermoregulation - body temperature control, heat production, heat loss mechanisms, hypothalamus function, and thermal homeostasis. Test your knowledge with detailed explanations and improve your exam preparation."
        />
        <meta 
          name="keywords" 
          content="MDCAT, thermoregulation, body temperature, homeostasis, hypothalamus, heat production, heat loss, vasodilation, vasoconstriction, sweating, shivering, biology quiz, medical exam, physiology, MCQs, practice questions" 
        />
        <meta name="author" content="MDCAT Prep" />
        <meta property="og:title" content="MDCAT Thermoregulation Quiz - Biology Temperature Regulation Practice" />
        <meta property="og:description" content="Practice MDCAT questions on thermoregulation with detailed explanations and improve your exam performance." />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://yourdomain.com/quizzes/thermoregulation" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="MDCAT Thermoregulation Quiz - Biology Practice" />
        <meta name="twitter:description" content="Test your knowledge of thermoregulation with our comprehensive MDCAT quiz." />
        <link rel="canonical" href="https://yourdomain.com/quizzes/thermoregulation" />
        <script type="application/ld+json">
          {`
            {
              "@context": "https://schema.org",
              "@type": "Quiz",
              "name": "MDCAT Thermoregulation Quiz",
              "description": "Practice MDCAT questions on thermoregulation with multiple choice questions and detailed explanations.",
              "educationalLevel": "advanced",
              "assesses": "Knowledge of thermoregulation and temperature homeostasis for medical entrance exams",
          ...
          >
            ...
            >
              ...
              <button
                ...
                className="px-6 py-2 bg-red-600 text-white rounded-lg shadow hover:bg-red-700 transition focus:ring-2 focus:ring-red-500 focus:outline-none"
              >
                Okay
              </button>
            </motion.div>
      ...
      {!quizStarted ? (
        ...
        >
          <div className="text-center mb-6">
            <div className="w-16 h-16 bg-red-100 dark:bg-red-900 rounded-full flex items-center justify-center mx-auto mb-4">
              <FaThermometerHalf className="text-2xl text-red-600 dark:text-red-400" />
            </div>
            <h1 className="text-3xl font-bold text-gray-800 dark:text-white mb-2">
              MDCAT Thermoregulation Quiz
            </h1>
            <p className="text-gray-600 dark:text-gray-300 mb-4">
              Comprehensive quiz with 100 questions covering all aspects of thermoregulation and body temperature control, essential for MDCAT biology preparation.
            </p>
            <div className="bg-red-100 dark:bg-red-900/30 p-3 rounded-lg mb-4">
              <h3 className="font-semibold text-red-800 dark:text-red-200">Set 1: 100 Questions</h3>
              <p className="text-sm text-red-700 dark:text-red-300 mt-1">
                Detailed questions on temperature regulation mechanisms, hypothalamic control, and thermal homeostasis.
              </p>
            </div>
          </div>
          ...
          <div className="mb-6">
            ...
            <div className="grid grid-cols-2 gap-3 mb-4">
              <div className="bg-red-50 dark:bg-red-900/20 p-3 rounded-lg text-center">
                ...
                <div className="text-xs text-red-700 dark:text-red-300">Questions</div>
              </div>
              <div className="bg-red-50 dark:bg-red-900/20 p-3 rounded-lg text-center">
                <div className="text-2xl font-bold text-red-600 dark:text-red-400">10</div>
                <div className="text-xs text-red-700 dark:text-red-300">Sections</div>
              </div>
            </div>
            ...
            <div className="bg-gray-100 dark:bg-gray-700 p-4 rounded-lg">
              ...
              <ul className="text-xs text-gray-600 dark:text-gray-300 list-disc pl-5 space-y-1">
                <li>Principles of thermoregulation</li>
                <li>Hypothalamus and temperature control</li>
                <li>Heat production mechanisms</li>
                <li>Heat loss mechanisms</li>
                <li>Vasodilation and vasoconstriction</li>
                <li>Sweating and shivering responses</li>
                <li>Fever and pyrogens</li>
                <li>Thermoregulation disorders</li>
                <li className="text-xs text-red-700 dark:text-red-300">Thermoregulation and  its needs</li>
              </ul>
            </div>
          </div>
          ...
          <button
            ...
            className="w-full py-3 bg-red-600 text-white rounded-xl hover:bg-red-700 transition focus:ring-2 focus:ring-red-500 focus:outline-none"
            aria-label="Start Thermoregulation quiz"
          >
            Start Quiz
          </button>
        </motion.div>
        ...
        >
          <div className="p-5 border-b border-gray-200 dark:border-gray-700">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
              ...
              <span className="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-red-100 text-red-800 dark:bg-red-900/30 dark:text-red-200">
                SET 1
              </span>
            </div>
                ...
                >
                  ...
                  <div className="space-y-3">
                    {q.options.map((option, index) => {
                      ...
                      let buttonClass =
                        "w-full p-3 rounded-lg transition-all text-left focus:outline-none focus:ring-2 focus:ring-red-500 ";
                  ...
                  {isLocked && (
                    <div className="mt-4">
                      <button
                        ...
                        className="flex items-center space-x-2 text-red-600 dark:text-red-400 hover:text-red-700 dark:hover:text-red-300 text-sm font-medium"
                      ...
                      <AnimatePresence>
                        {showExplanations[q.id] && (
                          <motion.div
                            ...
                            className="mt-3 p-3 bg-red-50 dark:bg-gray-600 rounded-lg text-sm text-gray-700 dark:text-gray-200"
                            aria-live="polite"
                          >
                            {q.explanation}
                          </motion.div>
          ...
          <div className="p-5 border-t border-gray-200 dark:border-gray-700 flex flex-col sm:flex-row justify-between items-center space-y-4 sm:space-y-0">
            ...
            <button
              ...
              className="px-4 py-2 rounded-lg flex items-center space-x-2 bg-red-600 hover:bg-red-700 text-white focus:ring-2 focus:ring-red-500 focus:outline-none"
        ...
        >
          <div className="p-6 text-center">
            <div className="w-20 h-20 bg-red-100 dark:bg-red-900 rounded-full flex items-center justify-center mx-auto mb-5">
            ...
            <p className="text-gray-600 dark:text-gray-300 mb-5">
              You scored <span className="font-bold text-red-600 dark:text-red-400">{score}%</span> out of{" "}
            ...
            <div className="space-y-3">
              <button
                ...
                className="w-full py-3 bg-red-600 text-white rounded-lg hover:bg-red-700 flex items-center justify-center space-x-2 focus:ring-2 focus:ring-red-500 focus:outline-none"
      ...
      <AnimatePresence>
        {showTopBtn && (
          <motion.button
            ...
            className="fixed bottom-4 right-4 bg-red-600 text-white p-3 rounded-full shadow-lg hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2"
...
export default ThermoregulationQuiz;