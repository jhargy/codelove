...
import { humanSkeletonQuestions } from "../data/humanSkeletonQuestions";
import {
  FaBone,
  FaArrowLeft,
  FaArrowRight,
...
const HumanSkeletonQuiz: React.FC = () => {
  ...
  const TOTAL_QUESTIONS = humanSkeletonQuestions.length;
  const SECTIONS = Math.ceil(TOTAL_QUESTIONS / QUESTIONS_PER_SECTION);

  const currentQuestions = humanSkeletonQuestions.slice(
  ...
  const handleAnswer = (id: string, index: number) => {
    try {
      ...
      const question = humanSkeletonQuestions.find((q) => q.id === id);
      if (!question) {
  ...
  const calculateScore = () => {
    try {
      let correct = 0;
      humanSkeletonQuestions.forEach((q) => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-blue-100 dark:from-gray-900 dark:to-blue-900/20 py-6 px-4 sm:px-6 lg:py-8">
      <Helmet>
        <title>MDCAT Human Skeleton Quiz | Biology Skeletal System Practice Questions</title>
        <meta
          name="description"
          content="Comprehensive MDCAT quiz on human skeleton - bones, joints, axial and appendicular skeleton, bone physiology, and skeletal disorders. Test your knowledge with detailed explanations and improve your exam preparation."
        />
        <meta 
          name="keywords" 
          content="MDCAT, human skeleton, bones, skeletal system, axial skeleton, appendicular skeleton, joints, bone physiology, osteology, biology quiz, medical exam, anatomy, MCQs, practice questions" 
        />
        <meta name="author" content="MDCAT Prep" />
        <meta property="og:title" content="MDCAT Human Skeleton Quiz - Biology Skeletal System Practice" />
        <meta property="og:description" content="Practice MDCAT questions on human skeleton with detailed explanations and improve your exam performance." />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://yourdomain.com/quizzes/human-skeleton" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="MDCAT Human Skeleton Quiz - Biology Practice" />
        <meta name="twitter:description" content="Test your knowledge of human skeleton with our comprehensive MDCAT quiz." />
        <link rel="canonical" href="https://yourdomain.com/quizzes/human-skeleton" />
      </Helmet>
        ...
        >
          <div className="text-center mb-6">
            <div className="w-16 h-16 bg-blue-100 dark:bg-blue-900 rounded-full flex items-center justify-center mx-auto mb-4">
              <FaBone className="text-2xl text-blue-600 dark:text-blue-400" />
            </div>
            <h1 className="text-3xl font-bold text-gray-800 dark:text-white mb-2">
              MDCAT Human Skeleton Quiz
            </h1>
            <p className="text-gray-600 dark:text-gray-300 mb-4">
              Comprehensive quiz with 150 questions covering all aspects of the human skeletal system, essential for MDCAT biology preparation.
            </p>
            <div className="bg-blue-100 dark:bg-blue-900/30 p-3 rounded-lg mb-4">
              <h3 className="font-semibold text-blue-800 dark:text-blue-200">Set 1: 150 Questions</h3>
              <p className="text-sm text-blue-700 dark:text-blue-300 mt-1">
                Detailed questions on bones, joints, skeletal physiology, and musculoskeletal disorders.
              </p>
            </div>
          </div>
          ...
          <div className="mb-6">
            ...
            <div className="grid grid-cols-2 gap-3 mb-4">
              ...
              <div className="bg-blue-50 dark:bg-blue-900/20 p-3 rounded-lg text-center">
                ...
                <div className="text-xs text-blue-700 dark:text-blue-300">Sections</div>
              </div>
            </div>
            ...
            <div className="bg-gray-100 dark:bg-gray-700 p-4 rounded-lg">
              ...
              <ul className="text-xs text-gray-600 dark:text-gray-300 list-disc pl-5 space-y-1">
                <li>Axial Skeleton (Skull, Vertebral Column, Ribs)</li>
                <li>Appendicular Skeleton (Limbs, Girdles)</li>
                <li>Bone Structure and Histology</li>
                <li className="text-xs text-blue-700 dark:text-blue-300">Cartilage, Muscle and Bone</li>
                <li className="text-xs text-blue-700 dark:text-blue-300">The main characteristics of cartilage and bone along with functions</li>
                <li>Skeletal Muscles and Attachments</li>
                <li>Bone Physiology and Calcium Homeostasis</li>
                <li>Common Skeletal Disorders</li>
                <li>Fractures and Bone Healing</li>
                <li>Comparative Anatomy of Skeleton</li>
              </ul>
            </div>
          </div>
          ...
          <button
            ...
            className="w-full py-3 bg-blue-600 text-white rounded-xl hover:bg-blue-700 transition focus:ring-2 focus:ring-blue-500 focus:outline-none"
            aria-label="Start Human Skeleton quiz"
          >
            Start Quiz
          </button>
        </motion.div>
        ...
        >
                ...
                >
                  ...
                  <div className="space-y-3">
                    {q.options.map((option, index) => {
                      ...
                      let buttonClass =
                        "w-full p-3 rounded-lg transition-all text-left focus:outline-none focus:ring-2 focus:ring-blue-500 ";
          ...
          <div className="p-5 border-t border-gray-200 dark:border-gray-700 flex flex-col sm:flex-row justify-between items-center space-y-4 sm:space-y-0">
            ...
            <button
              ...
              className="px-4 py-2 rounded-lg flex items-center space-x-2 bg-blue-600 hover:bg-blue-700 text-white focus:ring-2 focus:ring-blue-500 focus:outline-none"
        ...
        >
          <div className="p-6 text-center">
            ...
            {score !== null && (
              <div className="mb-6">
                {score >= 80 ? (
                  <div className="text-blue-600 dark:text-blue-400 font-semibold flex items-center justify-center space-x-2">
            ...
            <div className="space-y-3">
              <button
                ...
                className="w-full py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 flex items-center justify-center space-x-2 focus:ring-2 focus:ring-blue-500 focus:outline-none"
...
export default HumanSkeletonQuiz;