...
const MdcatVirusesQuiz: React.FC = () => {
  ...
  const getQuestions = useCallback((): Question[] => {
    try {
      ...
      return virusesQuestions[difficulty] || [];
    } catch (err) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 to-blue-100 dark:from-gray-900 dark:to-gray-800 py-6 px-4 sm:px-6 lg:py-8">
      <Helmet>
        <title>MDCAT Viruses Quiz | Biology Practice</title>
        <meta
          name="description"
          content="Practice MDCAT Viruses questions with MCQs. Test your knowledge with explanations and instant feedback."
        />
        <meta name="keywords" content="mdcat, viruses, biology, virology, quiz, mcq, practice, medical, exam" />
        <script type="application/ld+json">
          {`
            {
              "@context": "https://schema.org",
              "@type": "Quiz",
              "name": "MDCAT Viruses Quiz",
              "description": "Practice MDCAT Viruses questions with multiple choice questions and detailed explanations.",
        ...
        >
          <div className="text-center mb-6">
            ...
            <p className="text-gray-600 dark:text-gray-300">
              Test your knowledge of virology for MDCAT with interactive MCQs covering virus structure, classification, and diseases.
            </p>
          </div>
...
export default MdcatVirusesQuiz;