...
const HumanHeartQuiz: React.FC = () => {
  ...
  const TOTAL_QUESTIONS = humanHeartQuestions.length;
  const SECTIONS = Math.ceil(TOTAL_QUESTIONS / QUESTIONS_PER_SECTION);

  const currentQuestions = humanHeartQuestions.slice(
  ...
  const handleAnswer = (id: string, index: number) => {
    try {
      ...
      const question = humanHeartQuestions.find((q) => q.id === id);
      if (!question) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-red-50 to-pink-100 dark:from-gray-900 dark:to-red-900/20 py-6 px-4 sm:px-6 lg:py-8">
      <Helmet>
        <title>MDCAT Human Heart Quiz | Biology Practice</title>
        <meta
          name="description"
          content="Practice MDCAT questions on the human heart. Test your knowledge of heart anatomy, physiology, cardiac cycle, and circulatory system with detailed explanations."
        />
        <meta name="keywords" content="mdcat, human heart, cardiovascular system, heart anatomy, cardiac cycle, circulation, biology, quiz, mcq, practice, medical, exam" />
        <script type="application/ld+json">
          {`
            {
              "@context": "https://schema.org",
              "@type": "Quiz",
              "name": "MDCAT Human Heart Quiz",
              "description": "Practice MDCAT questions on the human heart with multiple choice questions and detailed explanations.",
              "educationalLevel": "advanced",
              "assesses": "Knowledge of human heart and cardiovascular system for medical entrance exams",
        ...
        >
          <div className="text-center mb-6">
            ...
            <h1 className="text-3xl font-bold text-gray-800 dark:text-white mb-2">
              MDCAT Human Heart Quiz
            </h1>
            <p className="text-gray-600 dark:text-gray-300 mb-4">
              Comprehensive quiz with 120 questions covering all aspects of the human heart and cardiovascular system, essential for MDCAT biology preparation.
            </p>
            <div className="bg-red-100 dark:bg-red-900/30 p-3 rounded-lg mb-4">
              <h3 className="font-semibold text-red-800 dark:text-red-200">Set 1: 120 Questions</h3>
              <p className="text-sm text-red-700 dark:text-red-300 mt-1">
                Detailed questions on heart anatomy, physiology, cardiac cycle, and circulatory system.
              </p>
            </div>
          </div>
          ...
          <div className="mb-6">
            ...
            <div className="grid grid-cols-2 gap-3 mb-4">
              <div className="bg-red-50 dark:bg-red-900/20 p-3 rounded-lg text-center">
                <div className="text-2xl font-bold text-red-600 dark:text-red-400">120</div>
            ...
            <div className="bg-gray-100 dark:bg-gray-700 p-4 rounded-lg">
              ...
              <ul className="text-xs text-gray-600 dark:text-gray-300 list-disc pl-5 space-y-1">
                <li>Heart anatomy and chambers</li>
                <li>Blood flow through the heart</li>
                <li>Cardiac cycle and heart sounds</li>
                <li>Electrical conduction system</li>
                <li className= "text-sm text-green-400 dark:text-green-300 mt-1" > General structure of human heart</li>
                <li>Cardiac output and regulation</li>
                <li>Heart valves and their functions</li>
                <li>Coronary circulation</li>
                <li className= "text-sm text-green-400 dark:text-green-300 mt-1" >Cardiac cycle and phases of Heartbeat</li>
              </ul>
            </div>
          </div>
