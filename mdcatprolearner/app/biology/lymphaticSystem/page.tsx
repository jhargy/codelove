...
import {
  lymphaticSystemQuestions,
  Question,
} from "../data/lymphaticSystemQuestions";
import {
  FaShieldAlt,
  FaArrowLeft,
  FaArrowRight,
...
const LymphaticSystemQuiz: React.FC = () => {
  ...
  const TOTAL_QUESTIONS = lymphaticSystemQuestions.length;
  const SECTIONS = Math.ceil(TOTAL_QUESTIONS / QUESTIONS_PER_SECTION);

  const currentQuestions = lymphaticSystemQuestions.slice(
  ...
  const handleAnswer = (id: string, index: number) => {
    try {
      ...
      const question = lymphaticSystemQuestions.find((q) => q.id === id);
      if (!question) {
  ...
  const calculateScore = () => {
    try {
      let correct = 0;
      lymphaticSystemQuestions.forEach((q) => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-50 to-teal-100 dark:from-gray-900 dark:to-green-900/20 py-6 px-4 sm:px-6 lg:py-8">
      <Helmet>
        <title>MDCAT Lymphatic System Quiz | Biology Practice Questions</title>
        <meta
          name="description"
          content="Comprehensive MDCAT quiz on the lymphatic system - lymph nodes, vessels, immunity, and fluid balance. Test your knowledge with detailed explanations and improve your exam preparation."
        />
        <meta 
          name="keywords" 
          content="MDCAT, lymphatic system, lymph nodes, lymph vessels, immunity, immune system, biology quiz, medical exam, physiology, lymphocytes, MCQs, practice questions, lymph, spleen, thymus" 
        />
        <meta name="author" content="MDCAT Prep" />
        <meta property="og:title" content="MDCAT Lymphatic System Quiz - Biology Practice" />
        <meta property="og:description" content="Practice MDCAT questions on the lymphatic system with detailed explanations and improve your exam performance." />
        <meta property="og:type" content="website" />
        <link rel="canonical" href="https://yourdomain.com/quizzes/lymphatic-system" />
        <script type="application/ld+json">
          {`
            {
              "@context": "https://schema.org",
              "@type": "Quiz",
              "name": "MDCAT Lymphatic System Quiz",
              "description": "Practice MDCAT questions on the lymphatic system with multiple choice questions and detailed explanations.",
              "educationalLevel": "advanced",
              "assesses": "Knowledge of lymphatic system and immunity for medical entrance exams",
        ...
        >
          <div className="text-center mb-6">
            ...
            <h1 className="text-3xl font-bold text-gray-800 dark:text-white mb-2">
              MDCAT Lymphatic System Quiz
            </h1>
            <p className="text-gray-600 dark:text-gray-300 mb-4">
              Comprehensive quiz with 90 questions covering all aspects of the lymphatic system and immunity, essential for MDCAT biology preparation.
            </p>
            <div className="bg-green-100 dark:bg-green-900/30 p-3 rounded-lg mb-4">
              <h3 className="font-semibold text-green-800 dark:text-green-200">Set 1: 90 Questions</h3>
              <p className="text-sm text-green-700 dark:text-green-300 mt-1">
                Detailed questions on lymph nodes, vessels, immune cells, and defense mechanisms.
              </p>
            </div>
          </div>
          ...
          <div className="mb-6">
            ...
            <div className="grid grid-cols-2 gap-3 mb-4">
              ...
              <div className="bg-green-50 dark:bg-green-900/20 p-3 rounded-lg text-center">
                ...
                <div className="text-xs text-green-700 dark:text-green-300">Sections</div>
              </div>
            </div>
            ...
            <div className="bg-gray-100 dark:bg-gray-700 p-4 rounded-lg">
              ...
              <ul className="text-xs text-gray-600 dark:text-gray-300 list-disc pl-5 space-y-1">
                <li>Lymphatic vessels and lymph flow</li>
                <li>Lymph nodes and their functions</li>
                <li>Spleen, thymus, and tonsils</li>
                <li>Immune cells (lymphocytes, macrophages)</li>
                <li>Innate vs. adaptive immunity</li>
                <li>Antibodies and immune response</li>
                <li>Lymphatic disorders and diseases</li>
                <li className= "text-sm text-green-400 dark:text-green-300 mt-1 /"> Lymphatic system (nodes, vessels and organs)</li>
              </ul>
            </div>
          </div>
          ...
          <button
            ...
            className="w-full py-3 bg-green-600 text-white rounded-xl hover:bg-green-700 transition focus:ring-2 focus:ring-green-500 focus:outline-none"
            aria-label="Start Lymphatic System quiz"
          >
            Start Quiz
          </button>
        </motion.div>
                  ...
                  <div className="space-y-3">
                    {q.options.map((option, index) => {
                      ...
                      if (isLocked) {
                        if (isCorrectOption) {
                          buttonClass +=
                            " bg-green-50 dark:bg-green-900/30 border极狐 border-green-200 dark:border-green-800 text-green-800 dark:text-green-200";
                  ...
                  {isLocked && (
                    <div className="mt-4">
                      <button
                        ...
                        className="flex items-center space-x-2 text-green-600 dark:text-green-400 hover:text-green-700 dark:hover:text-green-300 text-sm font-medium"
                      ...
                      <AnimatePresence>
                        {showExplanations[q.id] && (
                          <motion.div
                            ...
                            className="mt-3 p-3 bg-green-50 dark:bg-gray-600 rounded-lg text-sm text-gray-700 dark:text-gray-200"
                            aria-live="polite"
                          >
                            {q.explanation}
                          </motion.div>
        ...
        >
          <div className="p-6 text-center">
            ...
            <p className="text-gray-600 dark:text-gray-300 mb-5">
              You scored <span className="font-bold text-green-600 dark:text-green-400">{score}%</span> out of{" "}
            ...
            {score !== null && (
              <div className="mb-6">
                {score >= 80 ? (
                  <div className="text-green-600 dark:text-green-400 font-semib极狐old flex items-center justify-center space-x-2">
...
export default LymphaticSystemQuiz;