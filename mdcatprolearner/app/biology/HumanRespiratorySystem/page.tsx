...
import {
  humanRespiratorySystemQuestions,
  Question,
} from "../data/humanRespiratorySystemQuestions";
import {
  FaLungs,
  FaArrowLeft,
  FaArrowRight,
...
const HumanRespiratorySystemQuiz: React.FC = () => {
  ...
  const TOTAL_QUESTIONS = humanRespiratorySystemQuestions.length;
  const SECTIONS = Math.ceil(TOTAL_QUESTIONS / QUESTIONS_PER_SECTION);

  const currentQuestions = humanRespiratorySystemQuestions.slice(
  ...
  const handleAnswer = (id: string, index: number) => {
    try {
      ...
      const question = humanRespiratorySystemQuestions.find((q) => q.id === id);
      if (!question) {
  ...
  const calculateScore = () => {
    try {
      let correct = 0;
      humanRespiratorySystemQuestions.forEach((q) => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-cyan-100 dark:from-gray-900 dark:to-blue-900/20 py-6 px-4 sm:px-6 lg:py-8">
      <Helmet>
        <title>MDCAT Human Respiratory System Quiz | Biology Practice Questions</title>
        <meta
          name="description"
          content="Comprehensive MDCAT quiz on the human respiratory system - lungs, gas exchange, breathing mechanisms, and respiratory disorders. Test your knowledge with detailed explanations and improve your exam preparation."
        />
        <meta 
          name="keywords" 
          content="MDCAT, respiratory system, lungs, alveoli, gas exchange, breathing, diaphragm, trachea, bronchi, biology quiz, medical exam, physiology, MCQs, practice questions, respiratory disorders" 
        />
        <meta name="author" content="MDCAT Prep" />
        <meta property="og:title" content="MDCAT Human Respiratory System Quiz - Biology Practice" />
        <meta property="og:description" content="Practice MDCAT questions on the human respiratory system with detailed explanations and improve your exam performance." />
        <meta property="og:type" content="website" />
        <link rel="canonical" href="https://yourdomain.com/quizzes/human-respiratory-system" />
        <script type="application/ld+json">
          {`
            {
              "@context": "https://schema.org",
              "@type": "Quiz",
              "name": "MDCAT Human Respiratory System Quiz",
              "description": "Practice MDCAT questions on the human respiratory system with multiple choice questions and detailed explanations.",
              "educationalLevel": "advanced",
              "assesses": "Knowledge of human respiratory system for medical entrance exams",
        ...
        >
          <div className="text-center mb-6">
            <div className="w-16 h-16 bg-blue-100 dark:bg-blue-900 rounded-full flex items-center justify-center mx-auto mb-4">
              <FaLungs className="text-2xl text-blue-600 dark:text-blue-400" />
            </div>
            <h1 className="text-3xl font-bold text-gray-800 dark:text-white mb-2">
              MDCAT Human Respiratory System Quiz
            </h1>
            <p className="text-gray-600 dark:text-gray-300 mb-4">
              Comprehensive quiz with 80 questions covering all aspects of the human respiratory system, essential for MDCAT biology preparation.
            </p>
            <div className="bg-blue-100 dark:bg-blue-900/30 p-3 rounded-lg mb-4">
              <h3 className="font-semibold text-blue-800 dark:text-blue-200">Set 1: 80 Questions</h3>
              <p className="text-sm text-blue-700 dark:text-blue-300 mt-1">
                Detailed questions on lungs, gas exchange, breathing mechanisms, and respiratory disorders.
              </p>
            </div>
          </div>
          ...
          <div className="mb-6">
            ...
            <div className="bg-gray-100 dark:bg-gray-700 p-4 rounded-lg">
              ...
              <ul className="text-xs text-gray-600 dark:text-gray-300 list-disc pl-5 space-y-1">
                <li  className= "text-sm text-green-400 dark:text-green-300 mt-1 /">Anatomy of respiratory system</li>
                <li>Mechanism of breathing</li>
                <li>Gas exchange and transport</li>
                <li>Regulation of respiration</li>
                <li>Respiratory volumes and capacities</li>
                <li>Respiratory disorders and diseases</li>
                <li>Oxygen and carbon dioxide transport</li>
          ...
          <button
            ...
            aria-label="Start Human Respiratory System quiz"
          >
            Start Quiz
          </button>
        </motion.div>
...
export default HumanRespiratorySystemQuiz;