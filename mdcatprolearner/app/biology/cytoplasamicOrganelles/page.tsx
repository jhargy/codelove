...
import {
  cytoplasmicOrganellesQuestions,
  Question,
} from "../data/cytoplasmicOrganellesQuestions";
import {
  FaMicroscope,
  FaArrowLeft,
  FaArrowRight,
...
const CytoplasmicOrganellesQuiz: React.FC = () => {
  ...
  const TOTAL_QUESTIONS = cytoplasmicOrganellesQuestions.length;
  const SECTIONS = Math.ceil(TOTAL_QUESTIONS / QUESTIONS_PER_SECTION);

  const currentQuestions = cytoplasmicOrganellesQuestions.slice(
  ...
  const handleAnswer = (id: string, index: number) => {
    try {
      ...
      const question = cytoplasmicOrganellesQuestions.find((q) => q.id === id);
      if (!question) {
  ...
  const calculateScore = () => {
    try {
      let correct = 0;
      cytoplasmicOrganellesQuestions.forEach((q) => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-teal-50 to-cyan-100 dark:from-gray-900 dark:to-teal-900/20 py-6 px-4 sm:px-6 lg:py-8">
      <Helmet>
        <title>MDCAT Cytoplasmic Organelles Quiz | Biology Practice</title>
        <meta
          name="description"
          content="Practice MDCAT questions on cytoplasmic organelles. Test your knowledge of mitochondria, endoplasmic reticulum, Golgi apparatus, and other cellular organelles with explanations."
        />
        <meta name="keywords" content="mdcat, cytoplasmic organelles, cell biology, mitochondria, endoplasmic reticulum, Golgi apparatus, lysosomes, quiz, mcq, practice, medical, exam" />
        <script type="application/ld+json">
          {`
            {
              "@context": "https://schema.org",
              "@type": "Quiz",
              "name": "MDCAT Cytoplasmic Organelles Quiz",
              "description": "Practice MDCAT questions on cytoplasmic organelles with multiple choice questions and detailed explanations.",
              "educationalLevel": "advanced",
              "assesses": "Knowledge of cell biology and organelles for medical entrance exams",
        ...
        >
          <div className="text-center mb-6">
            <div className="w-16 h-16 bg-teal-100 dark:bg-teal-900 rounded-full flex items-center justify-center mx-auto mb-4">
              <FaMicroscope className="text-2xl text-teal-600 dark:text-teal-400" />
            </div>
            <h1 className="text-3xl font-bold text-gray-800 dark:text-white mb-2">
              MDCAT Cytoplasmic Organelles Quiz
            </h1>
            <p className="text-gray-600 dark:text-gray-300 mb-4">
              Comprehensive quiz with 120 questions covering all aspects of cytoplasmic organelles, essential for MDCAT cell biology preparation.
            </p>
            <div className="bg-teal-100 dark:bg-teal-900/30 p-3 rounded-lg mb-4">
              <h3 className="font-semibold text-teal-800 dark:text-teal-200">Set 1: 120 Questions</h3>
              <p className="text-sm text-teal-700 dark:text-teal-300 mt-1">
                Detailed questions on structure, function, and interrelationships of cytoplasmic organelles.
              </p>
            </div>
          </div>
          ...
          <div className="mb-6">
            ...
            <div className="grid grid-cols-2 gap-3 mb-4">
              <div className="bg-teal-50 dark:bg-teal-900/20 p-3 rounded-lg text-center">
                <div className="text-2xl font-bold text-teal-600 dark:text-teal-400">120</div>
            ...
            <div className="bg-gray-100 dark:bg-gray-700 p-4 rounded-lg">
              ...
              <ul className="text-xs text-gray-600 dark:text-gray-300 list-disc pl-5 space-y-1">
                <li>Mitochondria structure and function</li>
                <li>Endoplasmic reticulum (smooth and rough)</li>
                <li>Golgi apparatus and protein processing</li>
                <li>Lysosomes and cellular digestion</li>
                <li>Ribosomes and protein synthesis</li>
                <li>Peroxisomes and detoxification</li>
                <li>Cytoskeleton components</li>
                <li>Vacuoles and storage</li>
              </ul>
            </div>
          </div>
...
export default CytoplasmicOrganellesQuiz;