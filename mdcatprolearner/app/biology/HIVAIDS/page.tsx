...
const HIVAIDSQuiz: React.FC = () => {
  ...
  const getQuestions = useCallback((): Question[] => {
    try {
      ...
      return AIDAndHIVQuestions[difficulty] || [];
    } catch (err) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 to-blue-100 dark:from-gray-900 dark:to-gray-800 py-6 px-4 sm:px-6 lg:py-8">
      <Helmet>
        <title>MDCAT AIDS and HIV Infection Quiz | Biology Practice</title>
        <meta
          name="description"
          content="Practice MDCAT AIDS and HIV Infection questions with MCQs. Test your knowledge with explanations and instant feedback."
        />
        <meta name="keywords" content="mdcat, AIDsAnd HIV, biology, virology, quiz, mcq, practice, medical, exam" />
        <script type="application/ld+json">
          {`
            {
              "@context": "https://schema.org",
              "@type": "Quiz",
              "name": "MDCAT AIDAndHIV Quiz",
              "description": "Practice MDCAT AID And HIV infection questions with multiple choice questions and detailed explanations.",
              "educationalLevel": "advanced",
              "assesses": "Knowledge of virology for medical entrance exams",
        ...
        >
          <div className="text-center mb-6">
            <div className="w-16 h-16 bg-indigo-100 dark:bg-indigo-900 rounded-full flex items-center justify-center mx-auto mb-4">
              <span className="text-2xl"><GiVirus/></span>
            </div>
            <h1 className="text-3xl font-bold text-gray-800 dark:text-white mb-2">
              MDCAT AIDS And HIV Infection Quiz
            </h1>
            <p className="text-gray-600 dark:text-gray-300">
              Test your knowledge of AIDS and HIV. The questions are designed to test deeper understanding of HIV/AIDS beyond basic facts, covering molecular mechanisms, clinical management, and public health aspects relevant to medical entrance examinations.
            </p>
          </div>
